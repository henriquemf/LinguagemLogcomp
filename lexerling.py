...
class Lexer():
    ...
    def _add_tokens(self):
        ...
        self.lg.add('DATA_TYPE', r'(player|enemy|boss|npc)')
        self.lg.add('ENTITY_TYPE', r'(enemy|boss)')
        self.lg.add('NAIL_IDENTIFIER', r'(purenail|coilednail|channellednail|sharpnail|oldnail)')
        self.lg.add('SPELL_IDENTIFIER', r'(desolatedive|howlingwraiths|vengefulspirit)')
        self.lg.add('DMG_TYPE', r'(playerdmg|upspelldmg|downspelldmg|horizontalspelldmg)')
